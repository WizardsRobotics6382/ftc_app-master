...
@Autonomous(name = "BlueD", group = "linear Opmode")                     // Register your Opmode. On the RC the Opmode will show up as the name string.

/* Extend the LinearOpMode.*/
public class BlueD extends LinearOpMode {
    ...
    public void runOpMode()/* This begins the initialization process fro the robot (after driver presses "INIT" on DS */ {
        ...
        F1.setPower(-1);
        F2.setPower(-1); //Spins the robot to the right
        R1.setPower(-1);
        R2.setPower(-1);
